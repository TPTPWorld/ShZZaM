...
NORMALIZATION_INSTRUCTION:str = "Rewrite all the following sentences in a clear, fixed point form, such that if I asked you to rewrite them again nothing would change. Questions must be rewritten as questions, and statements must be rewritten as statements. Add background knowledge if necessary to clarify the scenario. Provide all the rewritten sentences as plain text, no explanations or summary."
